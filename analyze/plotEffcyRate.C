void plotEffcyRate() {
	...
	// CH2 dataset
    const int n1 = 17;
    double x1[n1] = {0.25, 0.75, 1.25, 1.75, 2.25, 2.75, 3.25, 3.75, 4.25, 4.75, 5.25, 5.75, 6.25, 6.75, 7.25, 7.75, 8.25};
    double y1[n1] = {0.935252, 0.933053, 0.931257, 0.926053, 0.921416, 0.911457, 0.911291, 0.89313, 0.890583, 0.88443, 0.871141, 0.84492, 0.805994, 0.812121, 0.752818, 0.76016, 0.72807};
