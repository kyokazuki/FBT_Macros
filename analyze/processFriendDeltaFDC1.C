...
int processFriendDeltaFDC1(const TString& inPath1, const TString& inPath2) {
	...
	outTree->Branch("ts", &inData2.ts);
	// outTree->Branch("fdc1", &inData2.fdc1);
	outTree->Branch("wirez", inData2.wirez);
	// outTree->Branch("id_fdc1x1", &inData2.id_fdc1x1);
	// outTree->Branch("id_fdc1x2", &inData2.id_fdc1x2);
	// outTree->Branch("id_fdc1x3", &inData2.id_fdc1x3);
	// outTree->Branch("id_fdc1u1", &inData2.id_fdc1u1);
	// outTree->Branch("id_fdc1u2", &inData2.id_fdc1u2);
	// outTree->Branch("id_fdc1v1", &inData2.id_fdc1v1);
	// outTree->Branch("id_fdc1v2", &inData2.id_fdc1v2);
	Long64_t dtime, dts;
	outTree->Branch("dtime", &dtime);
	outTree->Branch("dts", &dts);
	...
	Long64_t firstTime2 = inData2.ts;
	inData2.tree->GetEntry(inData2.entries - 1);
	Long64_t lastTime2 = inData2.ts;
